...
package com.moonbloom.vlcremote.model;
...
public final class Preferences {
    ...
    public static final String KEY_ENABLE_VIBRATIONS = "enable_vibrate";
    ...
    public boolean isVibrationsEnabled() {
        return mPreferences.getBoolean(KEY_ENABLE_VIBRATIONS, false);
    }

    public boolean setVibrationsEnabled(boolean enableVibrations) {
        SharedPreferences.Editor editor = mPreferences.edit();
        editor.putBoolean(KEY_ENABLE_VIBRATIONS, enableVibrations);
        return editor.commit();
    }
    ...
    public Set<String> getLibraries() {
        return new HashSet<>(mPreferences.getStringSet(KEY_LIBRARIES, new HashSet<String>()));
    }
