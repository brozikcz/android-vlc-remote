...
package com.moonbloom.vlcremote.service;
...
import com.moonbloom.vlcremote.appwidget.MediaAppWidgetProvider;
...
import com.moonbloom.vlcremote.net.json.JsonContentHandler;
import com.moonbloom.vlcremote.widget.NotificationControls;
    ...
    public int onStartCommand(Intent intent, int flags, int startId) {
        ...
        if (Intents.ACTION_STATUS.equals(action) && uri != null) {
            ...
            if (isCommand(uri) || !handler.hasMessages(HANDLE_STATUS)) {
                int sequenceNumber = isCommand(uri) ? mSequenceNumber.incrementAndGet() : mSequenceNumber.get();
