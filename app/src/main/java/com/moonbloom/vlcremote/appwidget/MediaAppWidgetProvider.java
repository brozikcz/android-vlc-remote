...
package com.moonbloom.vlcremote.appwidget;
...
import com.moonbloom.vlcremote.widget.RemoteViewsFactory;
...
public class MediaAppWidgetProvider extends AppWidgetProvider {
    ...
    public void onReceive(Context context, Intent intent) {
        ...
        if (Intents.ACTION_MANUAL_APPWIDGET_UPDATE.equals(action) || ConnectivityManager.CONNECTIVITY_ACTION.equals(action)) {
            update(context);
        } else {
    ...
    public static int[] getWidgetIds(Context context) {
        ...
        ComponentName cn = new ComponentName(context, MediaAppWidgetProvider.class);
