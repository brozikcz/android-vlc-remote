...
import com.moonbloom.vlcremote.net.MediaServer.StatusRequest;
import com.moonbloom.vlcremote.net.MediaServer.StatusRequest.CommandInterface;
import com.moonbloom.vlcremote.net.MediaServer.StatusRequest.CommandInterface.PlaybackInterface;

/**
 * Controls playback and displays progress.
 */
public class PlaybackFragment extends MediaFragment implements View.OnClickListener, View.OnLongClickListener, OnSeekBarChangeListener {
    ...
    void onStatusChanged(Status status) {
        int resId = status.isPlaying() ? R.drawable.ic_media_pause : R.drawable.ic_media_play;
