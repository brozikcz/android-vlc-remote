...
import com.moonbloom.vlcremote.app.PickServerActivity;
...
import com.moonbloom.vlcremote.preference.ProgressCategory;
import com.moonbloom.vlcremote.receiver.PhoneStateChangedReceiver;
...
public final class PickServerFragment extends PreferenceFragment implements PortSweeper.Callback, ServerInfoDialog.ServerInfoDialogListener, OnPreferenceChangeListener {
    ...
    public void onAttach(Context context) {
        ...
        ((PickServerActivity) context).setServerInfoDialogListener(this);
    }
    ...
    private Map<String, Server> buildRememberedServersMap(List<String> keyList) {
        Map<String, Server> map = new HashMap<>(keyList.size());
    ...
    private ArrayList<String> buildRememberedServers() {
        ArrayList<String> list = new ArrayList<>(mRemembered.size());
    ...
    public boolean onPreferenceTreeClick(PreferenceScreen preferenceScreen, Preference preference) {
        if(isHandledByChangeListener(preference.getKey())) {
            ...
            return true;
        } else if (Preferences.KEY_ENABLE_VIBRATIONS.equals(preference.getKey())) {
            Preferences.get(getActivity()).setVibrationsEnabled(((CheckBoxPreference) preference).isChecked());
            return true;
