...
public class NavigationFragment extends MediaFragment implements View.OnTouchListener, GestureDetector.OnGestureListener {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup root, Bundle savedInstanceState) {
        ...
        isLockable = getArguments() != null && getArguments().getBoolean(ARG_IS_LOCKABLE, false);
        if(!isLockable) {
    ...
    private void vibrate() {
        if(Preferences.get(getActivity()).isVibrationsEnabled()) {
